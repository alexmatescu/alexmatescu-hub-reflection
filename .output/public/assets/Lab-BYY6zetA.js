import{i as e,n as t,t as n}from"./jsx-runtime-Cltr0gcK.js";import{n as r,t as i}from"./router-compat-Bw9qB0WQ.js";import{t as a}from"./arrow-left-BEErJzv1.js";import{t as o}from"./Seo-bZDNNx_t.js";import{C as s,E as c,S as l,T as u,_ as d,a as f,b as p,c as m,d as h,f as g,g as _,h as v,i as y,l as b,m as x,o as S,p as C,s as w,u as T,v as E,w as D,x as O,y as k}from"./index-BDTbI9QD.js";var A=e(t(),1),j=`
...
`,V=n(),H=`/images/blog/ai-visibility-hero.webp`,U={"/lab/introducere":j,"/lab/cercetare/ce-este-geo-aeo":M,"/lab/cercetare/cum-aleg-motoarele-ai":N,"/lab/cercetare/seo-vs-geo":P,"/lab/cercetare/cum-se-masoara-ai-visibility":F,"/lab/cercetare/glosar-geo-aeo":I,"/lab/metodologie/tabula-rasa-f0":L,"/lab/experimente-publice":R,"/lab/articole":z,"/lab/articole/istoria-cautarii-internet-evolutia-seo":E,"/lab/articole/motoare-cautare-comparatie-2026":_,"/lab/articole/social-media-vizibilitate-ai":x,"/lab/articole/cat-dureaza-indexare-citare-ai":u,"/lab/articole/paradoxul-site-ului-terminat":v,"/lab/articole/metadata-citare-ai-studiu-de-caz":d,"/lab/articole/audit-site-fara-acces-cod":c,"/lab/articole/cuvant-cheie-vs-fraza-tokenizare":s,"/lab/articole/paradoxul-specificitatii-continut-generic":k,"/lab/articole/ce-este-entitate-ai-studiu-de-caz":D,"/lab/articole/harta-de-citare-mentiuni-externe-romania":p,"/lab/articole/decalaj-viteza-ai-adoptie-2026":l,"/lab/articole/eticheta-abonat-relatia-prezentare-ai-search":O,"/lab/despre-laborator":B},W=Object.fromEntries(w.map(e=>[m(e),f(e)])),G=`Toate`,K=()=>{let[e,t]=(0,A.useState)(G),n=e===G?T:T.filter(t=>t.category===e);return(0,V.jsxs)(`div`,{className:`mt-16`,children:[(0,V.jsx)(`p`,{className:`eyebrow mb-6`,children:`Articole`}),(0,V.jsx)(`div`,{role:`group`,"aria-label":`Filtrează articolele după categorie`,className:`flex flex-wrap gap-2 mb-10`,children:[G,...y].map(n=>{let r=n===e;return(0,V.jsx)(`button`,{type:`button`,"aria-pressed":r,onClick:()=>t(n),className:`px-3.5 py-1.5 text-xs uppercase tracking-[0.12em] font-medium border rounded-sm transition-colors ${r?`border-foreground bg-foreground text-background`:`border-foreground/20 text-muted-foreground hover:border-foreground/40 hover:text-foreground`}`,children:n},n)})}),(0,V.jsx)(`ul`,{children:n.map(e=>{let t=b!==void 0&&e.canonical===b.canonical,n=m(e);return(0,V.jsx)(`li`,{className:`border-b border-foreground/10 first:border-t`,children:(0,V.jsxs)(i,{to:n,className:`group block py-8 md:py-10 ${t?`px-6 md:px-8 -mx-6 md:-mx-8 bg-surface/50 border-x border-foreground/10`:``}`,children:[t&&(0,V.jsx)(`p`,{className:`mb-3 text-[11px] uppercase tracking-[0.22em] font-semibold text-foreground`,children:`Cel mai nou`}),(0,V.jsxs)(`div`,{className:`flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1.5`,children:[(0,V.jsxs)(`p`,{className:`text-[11px] uppercase tracking-[0.2em] text-muted-foreground font-medium`,children:[e.category,` · `,e.articleType]}),(0,V.jsx)(`time`,{dateTime:e.datePublished,className:`text-[11px] uppercase tracking-[0.15em] text-muted-foreground/80 whitespace-nowrap`,children:S(e.datePublished)})]}),(0,V.jsx)(`h2`,{className:`font-serif leading-tight tracking-tight text-balance mt-3 group-hover:text-foreground ${t?`text-2xl md:text-4xl`:`text-xl md:text-2xl`}`,children:e.title}),(0,V.jsx)(`p`,{className:`mt-3 text-muted-foreground leading-relaxed max-w-2xl ${t?`text-base`:`text-sm`}`,children:e.description}),(0,V.jsx)(`span`,{className:`link-underline mt-4 text-sm font-medium`,children:`Citește →`})]})},e.canonical)})})]})},q=()=>(0,V.jsxs)(`div`,{children:[(0,V.jsx)(o,{title:`AI Visibility Lab — GEO și AEO pentru branduri | Alex Matescu`,description:`AI Visibility Lab este proiectul lui Alex Matescu despre GEO, AEO și vizibilitatea brandurilor în ChatGPT, Google AI Overviews și motoarele de căutare generative.`}),(0,V.jsxs)(`section`,{className:`relative border-b border-foreground/10 bg-[#0b0f0e] text-[#e8e0cf] overflow-hidden`,children:[(0,V.jsxs)(`div`,{className:`absolute inset-0`,children:[(0,V.jsx)(`img`,{src:H,alt:`AI Visibility Lab — ochiul care vede și este văzut de modelele generative`,className:`w-full h-full object-cover object-right opacity-90`}),(0,V.jsx)(`div`,{className:`absolute inset-0 bg-gradient-to-r from-[#0b0f0e] via-[#0b0f0e]/85 to-transparent`})]}),(0,V.jsxs)(`div`,{className:`relative container-editorial py-24 md:py-36 max-w-4xl`,children:[(0,V.jsx)(`h1`,{className:`font-serif text-4xl md:text-6xl leading-[1.05] tracking-tight text-balance text-[#f0e8d6]`,children:`AI Visibility Lab`}),(0,V.jsx)(`p`,{className:`mt-6 text-xs uppercase tracking-[0.28em] text-[#c9b98a]`,children:`Fi văzut. Fi înțeles. Fi citat.`}),(0,V.jsx)(`p`,{className:`mt-8 text-lg md:text-xl text-[#e8e0cf]/80 leading-relaxed max-w-2xl`,children:`Un spațiu de lucru dedicat GEO și AEO — cercetare, metodologie, experimente publice, articole și audit pentru cei care vor să fie găsiți, citați și recomandați de ChatGPT, Gemini, Perplexity, Claude și Copilot.`}),(0,V.jsxs)(`p`,{className:`mt-4 text-base text-[#e8e0cf]/70 leading-relaxed max-w-2xl`,children:[`AI Visibility Lab este fondat și coordonat de`,` `,(0,V.jsx)(i,{to:`/despre`,className:`underline underline-offset-4 hover:text-[#f0e8d6]`,children:`Alex Matescu`}),`, care documentează aici cercetarea, măsurătorile și optimizările realizate în domeniul AI Visibility, GEO și AEO.`]})]})]}),(0,V.jsx)(`section`,{className:`container-editorial py-16 md:py-24`,children:(0,V.jsx)(`div`,{className:`grid gap-px bg-foreground/10 border border-foreground/10 sm:grid-cols-2`,children:C.map((e,t)=>(0,V.jsxs)(i,{to:e.to,className:`group bg-background p-8 md:p-10 flex flex-col hover:bg-surface/60 transition-colors`,children:[(0,V.jsx)(`p`,{className:`eyebrow mb-4`,children:String(t+1).padStart(2,`0`)}),(0,V.jsx)(`h2`,{className:`font-serif text-2xl leading-tight tracking-tight text-balance group-hover:text-foreground`,children:e.label}),(0,V.jsx)(`p`,{className:`mt-4 text-sm text-muted-foreground leading-relaxed`,children:e.lead}),e.children&&(0,V.jsx)(`ul`,{className:`mt-6 space-y-2 border-t border-foreground/10 pt-4`,children:e.children.map(e=>(0,V.jsx)(`li`,{className:`text-sm text-muted-foreground/80`,children:e.label},e.to))})]},e.to))})})]}),J=({pathname:e})=>{let t=h(e);if(!t)return(0,V.jsx)(r,{to:`/lab`,replace:!0});let n=g(t.to),s=U[t.to],c=t.to in W,l=t.to===`/lab/articole`;return(0,V.jsxs)(`div`,{children:[(0,V.jsx)(o,{title:`${t.seoTitle??t.label} — AI Visibility Lab | Alex Matescu`,description:t.lead,...c?{ogType:`article`}:{}}),(0,V.jsx)(`section`,{className:`border-b border-foreground/10`,children:(0,V.jsxs)(`div`,{className:`container-editorial py-20 md:py-28 max-w-4xl`,children:[(0,V.jsxs)(i,{to:n?n.to:`/lab`,className:`inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors mb-8`,children:[(0,V.jsx)(a,{className:`h-3.5 w-3.5`}),n?n.label:`AI Visibility Lab`]}),(0,V.jsxs)(`p`,{className:`eyebrow mb-6`,children:[`AI Visibility Lab`,n?` · ${n.label}`:``]}),(0,V.jsx)(`h1`,{className:`font-serif text-3xl md:text-5xl leading-tight tracking-tight text-balance`,children:t.pageTitle??t.label}),(0,V.jsx)(`p`,{className:`mt-6 text-lg text-muted-foreground leading-relaxed max-w-2xl`,children:t.lead}),(()=>{let e=s?(0,V.jsx)(`div`,{className:`prose-editorial mt-14 max-w-2xl`,dangerouslySetInnerHTML:{__html:s}},`content`):(0,V.jsxs)(`div`,{className:`mt-10 p-6 md:p-8 border border-dashed border-foreground/15 rounded-sm bg-surface/40`,children:[(0,V.jsx)(`p`,{className:`text-sm uppercase tracking-[0.22em] text-muted-foreground mb-3`,children:`Pagină dedicată articolelor și studiilor de caz`}),(0,V.jsx)(`p`,{className:`text-base text-foreground/80 leading-relaxed`,children:`Secțiunea reunește în prezent analize și studii de caz publicate de AI Visibility Lab și este actualizată pe măsură ce activitatea de cercetare evoluează.”`})]},`content`),n=l?(0,V.jsx)(K,{},`children`):t.children&&(0,V.jsxs)(`div`,{className:`mt-16`,children:[(0,V.jsx)(`p`,{className:`eyebrow mb-6`,children:`În această secțiune`}),(0,V.jsx)(`ul`,{className:`grid gap-px bg-foreground/10 border border-foreground/10 sm:grid-cols-2`,children:t.children.map(e=>(0,V.jsx)(`li`,{className:`bg-background`,children:(0,V.jsxs)(i,{to:e.to,className:`group flex flex-col p-6 hover:bg-surface/60 transition-colors h-full`,children:[(0,V.jsx)(`span`,{className:`font-serif text-lg leading-tight text-balance group-hover:text-foreground`,children:e.label}),(0,V.jsx)(`span`,{className:`mt-2 text-sm text-muted-foreground leading-relaxed`,children:e.lead})]})},e.to))})]},`children`);return l?(0,V.jsxs)(V.Fragment,{children:[n,e]}):(0,V.jsxs)(V.Fragment,{children:[e,n]})})()]})})]})};export{q as n,J as t};