import{t as e}from"./jsx-runtime-Cltr0gcK.js";import{n as t,t as n}from"./router-compat-Bw9qB0WQ.js";import{t as r}from"./arrow-left-BEErJzv1.js";import{t as i}from"./Seo-B2m5xV9m.js";import{_ as a,a as o,c as s,d as c,f as l,g as u,h as d,i as f,l as p,m,o as h,p as g,s as _,u as v,v as y}from"./index-DFGWIAE-.js";var b=`
...
`,A=e(),j=`/images/blog/ai-visibility-hero.webp`,M={"/lab/introducere":b,"/lab/cercetare/ce-este-geo-aeo":x,"/lab/cercetare/cum-aleg-motoarele-ai":S,"/lab/cercetare/seo-vs-geo":C,"/lab/cercetare/cum-se-masoara-ai-visibility":w,"/lab/cercetare/glosar-geo-aeo":T,"/lab/metodologie/tabula-rasa-f0":E,"/lab/experimente-publice":D,"/lab/articole":O,"/lab/articole/istoria-cautarii-internet-evolutia-seo":g,"/lab/articole/motoare-cautare-comparatie-2026":c,"/lab/articole/social-media-vizibilitate-ai":p,"/lab/articole/cat-dureaza-indexare-citare-ai":a,"/lab/articole/paradoxul-site-ului-terminat":v,"/lab/articole/metadata-citare-ai-studiu-de-caz":l,"/lab/articole/audit-site-fara-acces-cod":y,"/lab/articole/cuvant-cheie-vs-fraza-tokenizare":d,"/lab/articole/paradoxul-specificitatii-continut-generic":m,"/lab/articole/ce-este-entitate-ai-studiu-de-caz":u,"/lab/despre-laborator":k},N=Object.fromEntries(o.map(e=>[new URL(e.canonical).pathname,f(e)])),P=()=>(0,A.jsxs)(`div`,{children:[(0,A.jsx)(i,{title:`AI Visibility Lab — GEO și AEO pentru branduri | Alex Matescu`,description:`AI Visibility Lab este proiectul lui Alex Matescu despre GEO, AEO și vizibilitatea brandurilor în ChatGPT, Google AI Overviews și motoarele de căutare generative.`}),(0,A.jsxs)(`section`,{className:`relative border-b border-foreground/10 bg-[#0b0f0e] text-[#e8e0cf] overflow-hidden`,children:[(0,A.jsxs)(`div`,{className:`absolute inset-0`,children:[(0,A.jsx)(`img`,{src:j,alt:`AI Visibility Lab — ochiul care vede și este văzut de modelele generative`,className:`w-full h-full object-cover object-right opacity-90`}),(0,A.jsx)(`div`,{className:`absolute inset-0 bg-gradient-to-r from-[#0b0f0e] via-[#0b0f0e]/85 to-transparent`})]}),(0,A.jsxs)(`div`,{className:`relative container-editorial py-24 md:py-36 max-w-4xl`,children:[(0,A.jsx)(`h1`,{className:`font-serif text-4xl md:text-6xl leading-[1.05] tracking-tight text-balance text-[#f0e8d6]`,children:`AI Visibility Lab`}),(0,A.jsx)(`p`,{className:`mt-6 text-xs uppercase tracking-[0.28em] text-[#c9b98a]`,children:`Fi văzut. Fi înțeles. Fi citat.`}),(0,A.jsx)(`p`,{className:`mt-8 text-lg md:text-xl text-[#e8e0cf]/80 leading-relaxed max-w-2xl`,children:`Un spațiu de lucru dedicat GEO și AEO — cercetare, metodologie, experimente publice, articole și audit pentru cei care vor să fie găsiți, citați și recomandați de ChatGPT, Gemini, Perplexity, Claude și Copilot.`})]})]}),(0,A.jsx)(`section`,{className:`container-editorial py-16 md:py-24`,children:(0,A.jsx)(`div`,{className:`grid gap-px bg-foreground/10 border border-foreground/10 sm:grid-cols-2`,children:s.map((e,t)=>(0,A.jsxs)(n,{to:e.to,className:`group bg-background p-8 md:p-10 flex flex-col hover:bg-surface/60 transition-colors`,children:[(0,A.jsx)(`p`,{className:`eyebrow mb-4`,children:String(t+1).padStart(2,`0`)}),(0,A.jsx)(`h2`,{className:`font-serif text-2xl leading-tight tracking-tight text-balance group-hover:text-foreground`,children:e.label}),(0,A.jsx)(`p`,{className:`mt-4 text-sm text-muted-foreground leading-relaxed`,children:e.lead}),e.children&&(0,A.jsx)(`ul`,{className:`mt-6 space-y-2 border-t border-foreground/10 pt-4`,children:e.children.map(e=>(0,A.jsx)(`li`,{className:`text-sm text-muted-foreground/80`,children:e.label},e.to))})]},e.to))})})]}),F=({pathname:e})=>{let a=h(e);if(!a)return(0,A.jsx)(t,{to:`/lab`,replace:!0});let o=_(a.to),s=M[a.to],c=a.to in N;return(0,A.jsxs)(`div`,{children:[(0,A.jsx)(i,{title:`${a.seoTitle??a.label} — AI Visibility Lab | Alex Matescu`,description:a.lead,...c?{ogType:`article`}:{}}),(0,A.jsx)(`section`,{className:`border-b border-foreground/10`,children:(0,A.jsxs)(`div`,{className:`container-editorial py-20 md:py-28 max-w-4xl`,children:[(0,A.jsxs)(n,{to:o?o.to:`/lab`,className:`inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors mb-8`,children:[(0,A.jsx)(r,{className:`h-3.5 w-3.5`}),o?o.label:`AI Visibility Lab`]}),(0,A.jsxs)(`p`,{className:`eyebrow mb-6`,children:[`AI Visibility Lab`,o?` · ${o.label}`:``]}),(0,A.jsx)(`h1`,{className:`font-serif text-3xl md:text-5xl leading-tight tracking-tight text-balance`,children:a.pageTitle??a.label}),(0,A.jsx)(`p`,{className:`mt-6 text-lg text-muted-foreground leading-relaxed max-w-2xl`,children:a.lead}),s?(0,A.jsx)(`div`,{className:`prose-editorial mt-14 max-w-2xl`,dangerouslySetInnerHTML:{__html:s}}):(0,A.jsxs)(`div`,{className:`mt-10 p-6 md:p-8 border border-dashed border-foreground/15 rounded-sm bg-surface/40`,children:[(0,A.jsx)(`p`,{className:`text-sm uppercase tracking-[0.22em] text-muted-foreground mb-3`,children:`Pagină dedicată articolelor și studiilor de caz`}),(0,A.jsx)(`p`,{className:`text-base text-foreground/80 leading-relaxed`,children:`Secțiunea reunește în prezent analize și studii de caz publicate de AI Visibility Lab și este actualizată pe măsură ce activitatea de cercetare evoluează.”`})]}),a.children&&(0,A.jsxs)(`div`,{className:`mt-16`,children:[(0,A.jsx)(`p`,{className:`eyebrow mb-6`,children:`În această secțiune`}),(0,A.jsx)(`ul`,{className:`grid gap-px bg-foreground/10 border border-foreground/10 sm:grid-cols-2`,children:a.children.map(e=>(0,A.jsx)(`li`,{className:`bg-background`,children:(0,A.jsxs)(n,{to:e.to,className:`group flex flex-col p-6 hover:bg-surface/60 transition-colors h-full`,children:[(0,A.jsx)(`span`,{className:`font-serif text-lg leading-tight text-balance group-hover:text-foreground`,children:e.label}),(0,A.jsx)(`span`,{className:`mt-2 text-sm text-muted-foreground leading-relaxed`,children:e.lead})]})},e.to))})]})]})})]})};export{P as n,F as t};