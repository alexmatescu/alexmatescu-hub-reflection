import{t as e}from"./jsx-runtime-Cltr0gcK.js";import{n as t,t as n}from"./router-compat-Bw9qB0WQ.js";import{t as r}from"./arrow-left-BEErJzv1.js";import{t as i}from"./Seo-B2m5xV9m.js";import{_ as a,a as o,b as s,c,d as l,f as u,g as d,h as f,i as p,l as m,m as h,o as g,p as _,s as v,u as y,v as b,y as x}from"./index-B-pFPf1A.js";var S=`
...
`,M=e(),N=`/images/blog/ai-visibility-hero.webp`,P={"/lab/introducere":S,"/lab/cercetare/ce-este-geo-aeo":C,"/lab/cercetare/cum-aleg-motoarele-ai":w,"/lab/cercetare/seo-vs-geo":T,"/lab/cercetare/cum-se-masoara-ai-visibility":E,"/lab/cercetare/glosar-geo-aeo":D,"/lab/metodologie/tabula-rasa-f0":O,"/lab/experimente-publice":k,"/lab/articole":A,"/lab/articole/istoria-cautarii-internet-evolutia-seo":_,"/lab/articole/motoare-cautare-comparatie-2026":l,"/lab/articole/social-media-vizibilitate-ai":m,"/lab/articole/cat-dureaza-indexare-citare-ai":x,"/lab/articole/paradoxul-site-ului-terminat":y,"/lab/articole/metadata-citare-ai-studiu-de-caz":u,"/lab/articole/audit-site-fara-acces-cod":s,"/lab/articole/cuvant-cheie-vs-fraza-tokenizare":a,"/lab/articole/paradoxul-specificitatii-continut-generic":h,"/lab/articole/ce-este-entitate-ai-studiu-de-caz":b,"/lab/articole/harta-de-citare-mentiuni-externe-romania":f,"/lab/articole/decalaj-viteza-ai-adoptie-2026":d,"/lab/despre-laborator":j},F=Object.fromEntries(o.map(e=>[new URL(e.canonical).pathname,p(e)])),I=()=>(0,M.jsxs)(`div`,{children:[(0,M.jsx)(i,{title:`AI Visibility Lab — GEO și AEO pentru branduri | Alex Matescu`,description:`AI Visibility Lab este proiectul lui Alex Matescu despre GEO, AEO și vizibilitatea brandurilor în ChatGPT, Google AI Overviews și motoarele de căutare generative.`}),(0,M.jsxs)(`section`,{className:`relative border-b border-foreground/10 bg-[#0b0f0e] text-[#e8e0cf] overflow-hidden`,children:[(0,M.jsxs)(`div`,{className:`absolute inset-0`,children:[(0,M.jsx)(`img`,{src:N,alt:`AI Visibility Lab — ochiul care vede și este văzut de modelele generative`,className:`w-full h-full object-cover object-right opacity-90`}),(0,M.jsx)(`div`,{className:`absolute inset-0 bg-gradient-to-r from-[#0b0f0e] via-[#0b0f0e]/85 to-transparent`})]}),(0,M.jsxs)(`div`,{className:`relative container-editorial py-24 md:py-36 max-w-4xl`,children:[(0,M.jsx)(`h1`,{className:`font-serif text-4xl md:text-6xl leading-[1.05] tracking-tight text-balance text-[#f0e8d6]`,children:`AI Visibility Lab`}),(0,M.jsx)(`p`,{className:`mt-6 text-xs uppercase tracking-[0.28em] text-[#c9b98a]`,children:`Fi văzut. Fi înțeles. Fi citat.`}),(0,M.jsx)(`p`,{className:`mt-8 text-lg md:text-xl text-[#e8e0cf]/80 leading-relaxed max-w-2xl`,children:`Un spațiu de lucru dedicat GEO și AEO — cercetare, metodologie, experimente publice, articole și audit pentru cei care vor să fie găsiți, citați și recomandați de ChatGPT, Gemini, Perplexity, Claude și Copilot.`})]})]}),(0,M.jsx)(`section`,{className:`container-editorial py-16 md:py-24`,children:(0,M.jsx)(`div`,{className:`grid gap-px bg-foreground/10 border border-foreground/10 sm:grid-cols-2`,children:c.map((e,t)=>(0,M.jsxs)(n,{to:e.to,className:`group bg-background p-8 md:p-10 flex flex-col hover:bg-surface/60 transition-colors`,children:[(0,M.jsx)(`p`,{className:`eyebrow mb-4`,children:String(t+1).padStart(2,`0`)}),(0,M.jsx)(`h2`,{className:`font-serif text-2xl leading-tight tracking-tight text-balance group-hover:text-foreground`,children:e.label}),(0,M.jsx)(`p`,{className:`mt-4 text-sm text-muted-foreground leading-relaxed`,children:e.lead}),e.children&&(0,M.jsx)(`ul`,{className:`mt-6 space-y-2 border-t border-foreground/10 pt-4`,children:e.children.map(e=>(0,M.jsx)(`li`,{className:`text-sm text-muted-foreground/80`,children:e.label},e.to))})]},e.to))})})]}),L=({pathname:e})=>{let a=g(e);if(!a)return(0,M.jsx)(t,{to:`/lab`,replace:!0});let o=v(a.to),s=P[a.to],c=a.to in F,l=a.to===`/lab/articole`;return(0,M.jsxs)(`div`,{children:[(0,M.jsx)(i,{title:`${a.seoTitle??a.label} — AI Visibility Lab | Alex Matescu`,description:a.lead,...c?{ogType:`article`}:{}}),(0,M.jsx)(`section`,{className:`border-b border-foreground/10`,children:(0,M.jsxs)(`div`,{className:`container-editorial py-20 md:py-28 max-w-4xl`,children:[(0,M.jsxs)(n,{to:o?o.to:`/lab`,className:`inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors mb-8`,children:[(0,M.jsx)(r,{className:`h-3.5 w-3.5`}),o?o.label:`AI Visibility Lab`]}),(0,M.jsxs)(`p`,{className:`eyebrow mb-6`,children:[`AI Visibility Lab`,o?` · ${o.label}`:``]}),(0,M.jsx)(`h1`,{className:`font-serif text-3xl md:text-5xl leading-tight tracking-tight text-balance`,children:a.pageTitle??a.label}),(0,M.jsx)(`p`,{className:`mt-6 text-lg text-muted-foreground leading-relaxed max-w-2xl`,children:a.lead}),(()=>{let e=s?(0,M.jsx)(`div`,{className:`prose-editorial mt-14 max-w-2xl`,dangerouslySetInnerHTML:{__html:s}},`content`):(0,M.jsxs)(`div`,{className:`mt-10 p-6 md:p-8 border border-dashed border-foreground/15 rounded-sm bg-surface/40`,children:[(0,M.jsx)(`p`,{className:`text-sm uppercase tracking-[0.22em] text-muted-foreground mb-3`,children:`Pagină dedicată articolelor și studiilor de caz`}),(0,M.jsx)(`p`,{className:`text-base text-foreground/80 leading-relaxed`,children:`Secțiunea reunește în prezent analize și studii de caz publicate de AI Visibility Lab și este actualizată pe măsură ce activitatea de cercetare evoluează.”`})]},`content`),t=a.children&&(0,M.jsxs)(`div`,{className:`mt-16`,children:[(0,M.jsx)(`p`,{className:`eyebrow mb-6`,children:`În această secțiune`}),(0,M.jsx)(`ul`,{className:`grid gap-px bg-foreground/10 border border-foreground/10 sm:grid-cols-2`,children:a.children.map(e=>(0,M.jsx)(`li`,{className:`bg-background`,children:(0,M.jsxs)(n,{to:e.to,className:`group flex flex-col p-6 hover:bg-surface/60 transition-colors h-full`,children:[(0,M.jsx)(`span`,{className:`font-serif text-lg leading-tight text-balance group-hover:text-foreground`,children:e.label}),(0,M.jsx)(`span`,{className:`mt-2 text-sm text-muted-foreground leading-relaxed`,children:e.lead})]})},e.to))})]},`children`);return l?(0,M.jsxs)(M.Fragment,{children:[t,e]}):(0,M.jsxs)(M.Fragment,{children:[e,t]})})()]})})]})};export{I as n,L as t};