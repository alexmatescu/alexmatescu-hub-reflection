import { P as Seo, t as Link$1 } from "./router-CV_6XGsJ.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/calatoria-C0MvkGOR.js
var import_jsx_runtime = require_jsx_runtime();
var timeline = [
	{
		period: "1994–2009",
		title: "Copilărie în Strâmba Jiu",
		description: "Copilărie în Strâmba Jiu, județul Gorj, într-o familie modestă, construită în jurul muncii, familiei, onestității și educației."
	},
	{
		period: "2009–2013",
		title: "Liceu și primele joburi",
		description: "Ani de liceu, rezultate școlare bune, concursuri educative, primele experiențe de muncă și începutul independenței financiare."
	},
	{
		period: "2013–2017",
		title: "Licență la Craiova",
		description: "Studii de licență la Automatică și Informatică Aplicată în Craiova, viață de cămin, joburi studențești, muncă în call-center și primul contact serios cu mediul corporatist."
	},
	{
		period: "2017",
		title: "Prima încercare antreprenorială",
		description: "Magazin de haine în Craiova, experiență care s-a încheiat cu un eșec financiar și un credit important pentru posibilitățile de atunci."
	},
	{
		period: "2017–2020",
		title: "Master și mutări profesionale",
		description: "Studii de master la Automatică, Calculatoare și Electronică din Craiova, în paralel cu începutul carierei profesionale și mutările către Timișoara și București."
	},
	{
		period: "2017–2018",
		title: "Timișoara și mutarea la București",
		description: "Mutare la Timișoara, job în fabrică, căutarea primului loc de muncă de inginer și ulterior mutarea la București."
	},
	{
		period: "2018–2019",
	...
	},
	{
		period: "2019–2020",
		title: "Bertrandt",
		description: "Trecerea la Bertrandt și contactul cu un mediu profesional mai matur, înainte de perioada COVID-19."
	},
	{
		period: "2020–2021",
		title: "Întoarcerea acasă în pandemie",
		description: "Descoperirea educației online, a dezvoltării personale, a coachingului, mentoringului, investițiilor și productivității."
	},
	{
		period: "2021",
		title: "Afacerea de familie",
		description: "Dezvoltarea unei afaceri de familie în mediul rural, un magazin mixt construit pentru a răspunde nevoilor reale ale comunității locale."
	},
	{
		period: "2021–2024",
		title: "Vânzări și consultanță financiară",
		description: "Experiență în vânzări, consultanță financiară și asigurări prin OVB Allfinanz România."
	},
	{
		period: "2021–2023",
		title: "Atracțiile României",
		description: "Pornirea și dezvoltarea proiectului dedicat promovării destinațiilor turistice din România."
	},
	{
		period: "2022",
		title: "Mutarea la Sibiu",
		description: "Începutul unei perioade de așezare, reflecție și transformare interioară."
	},
	{
		period: "2025",
		title: "Taste the Corn",
		description: "Lansarea unui concept de retail alimentar construit în Sibiu, operaționalizat în jumătate de an și închis după alte câteva luni."
	},
	{
		period: "2025–2026",
		title: "CRANDIT — cartea",
		description: "Scrierea cărții CRANDIT – Mitul succesului peste noapte și transformarea experiențelor acumulate într-un proiect editorial și de idei."
	},
	{
		period: "2026",
		title: "Hub personal și direcție nouă",
		description: "Dezvoltarea hubului personal Alex Matescu, lansarea AI Visibility Lab și trecerea de la studiul GEO/AEO la aplicarea practică a metodologiilor pe proiecte proprii, prin măsurători, optimizări și documentare publică."
	}
];
var chapters = [
	{
...
var Calatoria = () => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			className: "container-editorial pt-16 md:pt-24 pb-12",
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					className: "font-serif text-4xl md:text-6xl tracking-tight text-balance leading-[1.05]",
					children: "Călătoria lui Alex Matescu"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-8 max-w-2xl space-y-5 text-lg text-muted-foreground leading-relaxed",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Aceasta este povestea drumului meu de la copilăria într-un sat din Gorj până la inginerie, antreprenoriat, scris și proiectele pe care le construiesc astăzi." }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Nu este o poveste despre un traseu liniar." }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Este o poveste despre încercări, muncă, mutări, eșecuri, disciplină, oameni, locuri, proiecte și lecțiile care au început, în timp, să capete sens." })
					]
				})
			]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			className: "container-editorial py-12 md:py-16 border-t border-foreground/10",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "eyebrow mb-6",
				children: "Pe scurt"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "max-w-3xl space-y-5 text-base md:text-lg leading-relaxed",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Alexandru (Alex) Matescu este inginer, antreprenor, fondator și coordonator AI Visibility Lab și autor român, născut și crescut în Strâmba Jiu, județul Gorj." }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-muted-foreground",
						children: "Parcursul său include experiențe în mediul rural, educație tehnică, muncă în restaurante, call-center, fabrică, inginerie automotive, vânzări, consultanță financiară, antreprenoriat, scris și dezvoltare personală."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-muted-foreground",
						children: "A studiat Automatică și Informatică Aplicată la Facultatea de Automatică, Calculatoare și Electronică din Craiova, unde a urmat studiile de licență în perioada 2013–2017 și studiile de master în perioada 2017–2020."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-muted-foreground",
						children: "După ce a lucrat în domenii diferite și a construit proiecte care au avut rezultate diferite, Alex Matescu a început să documenteze public lecțiile învățate despre muncă, disciplină, succes, tehnologie, antreprenoriat și sens."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-muted-foreground",
						children: "Printre proiectele sale se numără CRANDIT – Mitul succesului peste noapte, afacerea de familie din mediul rural, Taste the Corn, Atracțiile României și AI Visibility Lab."
					})
				]
			})]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "eyebrow mb-6",
					children: "Cronologie pe scurt"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					className: "font-serif text-3xl md:text-4xl tracking-tight mb-12",
					children: "De la Strâmba Jiu la astăzi"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
					className: "relative border-l border-foreground/15 pl-8 md:pl-12 space-y-12",
					children: timeline.map((m, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
						className: "relative",
						children: [
		...
		chapters.map((c, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			className: "container-editorial py-16 md:py-20 border-t border-foreground/10",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "eyebrow mb-6",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					className: "font-serif text-3xl md:text-5xl tracking-tight text-balance leading-tight mb-10",
					children: c.title
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "max-w-2xl space-y-6 text-base md:text-lg leading-relaxed text-muted-foreground",
					children: c.paragraphs.map((p, j) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: p }, j))
				})
			]
		}, i)),
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					className: "font-serif text-3xl md:text-4xl tracking-tight mb-10",
					children: "Despre călătoria lui Alex Matescu"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "max-w-3xl",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Accordion, {
						...
						children: faqs.map((f, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AccordionItem, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccordionTrigger, {
								className: "font-serif text-lg md:text-xl text-left",
								children: f.q
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "eyebrow mb-6",
				children: "Entități principale menționate"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
				className: "flex flex-wrap gap-2 max-w-4xl",
				children: entities.map((e) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "container-editorial py-16 md:py-20 grid gap-10 md:grid-cols-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link$1, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "Ce construiesc acum și ce am închis pe drum."
						})
					] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpRight, { className: "h-5 w-5 mt-1 text-muted-foreground group-hover:text-foreground transition-colors" })]
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "font-serif text-2xl leading-snug",
							children: "CRANDIT — cartea"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-3 text-sm text-muted-foreground",
							children: "Distilarea acestui drum într-un singur volum."
						})
					] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpRight, { className: "h-5 w-5 mt-1 text-muted-foreground group-hover:text-foreground transition-colors" })]
				})]
			})
