...
import { A as latestLabArticle, B as findLabPage, C as etichetaAbonatRelatiaPrezentareAiSearchHtml, D as labArticleMeta, E as istoriaCautariiHtml, F as paradoxulSpecificitatiiContinutGenericHtml, H as labNav, I as socialMediaVizibilitateAiHtml, L as sortedLabArticles, M as metadataCitareAiStudiuDeCazHtml, N as motoareCautareHtml, O as labArticlePathname, P as paradoxulSiteuluiTerminatHtml, R as sortedLabCaseStudies, S as decalajVitezaAiAdoptie2026Html, T as hartaDeCitareMentiuniExterneRomaniaHtml, U as Seo, V as findLabParent, _ as auditSiteFaraAccesCodHtml, b as ceEsteEntitateAiStudiuDeCazHtml, g as LAB_ARTICLE_CATEGORIES, j as latestLabCaseStudy, k as labCaseStudyMeta, n as Navigate$1, t as Link$1, v as buildArticleJsonLd, w as formatLabArticleDate, x as cuvantCheieVsFrazaTokenizareHtml, y as catDureazaIndexareCitareAiHtml, z as tabulaRasaEntityResolutionStudiuDeCazHtml } from "./router-DomSMBGf.mjs";
import { v as require_jsx_runtime } from "../_libs/@radix-ui/react-accordion+[...].mjs";
import { g as ArrowLeft } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/Lab-CTx1AW7K.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var avl001IntroductionHtml = `
...
`;
var avl200StandardDovaziMasurareTrasabilitateHtml = `
      <div class="avl-doc-card">
        <p class="avl-doc-overline">Document sursă</p>
...
`;
var avl202CadruMetodologicHtml = `
      <div class="avl-doc-card">
        <p class="avl-doc-overline">Document sursă</p>
...
trasabilitate</code></pre>
      ...
      <blockquote>Iată ce era înainte. Iată ce este acum. Iată diferența.</blockquote>
`;
var avl301ExperimentePubliceHtml = `
      <div class="avl-doc-card">
        <p class="avl-doc-overline">Document sursă</p>
...
`;
var heroImage = "/images/blog/ai-visibility-hero.webp";
var labPageContent = {
	...
	"/lab/metodologie/standard-dovezi-masurare-trasabilitate": avl200StandardDovaziMasurareTrasabilitateHtml,
	...
	"/lab/studii-de-caz/tabula-rasa-entity-resolution-studiu-de-caz": tabulaRasaEntityResolutionStudiuDeCazHtml,
...
*/
var labPageJsonLdOverrides = Object.fromEntries([...labArticleMeta, ...labCaseStudyMeta].map((meta) => [labArticlePathname(meta), buildArticleJsonLd(meta)]));
var ALL_CATEGORIES_FILTER = "Toate";
/**
...
*/
var LabArticleIndex = () => {
	const [activeCategory, setActiveCategory] = (0, import_react.useState)(ALL_CATEGORIES_FILTER);
	const visibleArticles = activeCategory === ALL_CATEGORIES_FILTER ? sortedLabArticles : sortedLabArticles.filter((meta) => meta.category === activeCategory);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [ALL_CATEGORIES_FILTER, ...LAB_ARTICLE_CATEGORIES].map((category) => {
					const isActive = category === activeCategory;
					return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						type: "button",
						"aria-pressed": isActive,
						onClick: () => setActiveCategory(category),
						className: `px-3.5 py-1.5 text-xs uppercase tracking-[0.12em] font-medium border rounded-sm transition-colors ${isActive ? "border-foreground bg-foreground text-background" : "border-foreground/20 text-muted-foreground hover:border-foreground/40 hover:text-foreground"}`,
						children: category
					}, category);
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { children: visibleArticles.map((meta) => {
				const isLatest = latestLabArticle !== void 0 && meta.canonical === latestLabArticle.canonical;
				const href = labArticlePathname(meta);
				return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
					className: "border-b border-foreground/10 first:border-t",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link$1, {
						to: href,
						className: `group block py-8 md:py-10 ${isLatest ? "px-6 md:px-8 -mx-6 md:-mx-8 bg-surface/50 border-x border-foreground/10" : ""}`,
						children: [
							isLatest && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mb-3 text-[11px] uppercase tracking-[0.22em] font-semibold text-foreground",
								children: "Cel mai nou"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
									...
									children: formatLabArticleDate(meta.datePublished)
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
								className: `font-serif leading-tight tracking-tight text-balance mt-3 group-hover:text-foreground ${isLatest ? "text-2xl md:text-4xl" : "text-xl md:text-2xl"}`,
								children: meta.title
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
*/
var LabCaseStudyIndex = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	className: "mt-16",
	children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
		className: "eyebrow mb-6",
		children: "Studii de caz"
	}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { children: sortedLabCaseStudies.map((meta) => {
		const isLatest = latestLabCaseStudy !== void 0 && meta.canonical === latestLabCaseStudy.canonical;
		const href = labArticlePathname(meta);
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
			className: "border-b border-foreground/10 first:border-t",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link$1, {
...
var LabIndex = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
	...
	/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: "relative border-b border-foreground/10 bg-[#0b0f0e] text-[#e8e0cf] overflow-hidden",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-gradient-to-r from-[#0b0f0e] via-[#0b0f0e]/85 to-transparent" })]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "relative container-editorial py-24 md:py-36 max-w-4xl",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					className: "font-serif text-4xl md:text-6xl leading-[1.05] tracking-tight text-balance text-[#f0e8d6]",
					children: "AI Visibility Lab"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-6 text-xs uppercase tracking-[0.28em] text-[#c9b98a]",
					children: "Fi văzut. Fi înțeles. Fi citat."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-8 text-lg md:text-xl text-[#e8e0cf]/80 leading-relaxed max-w-2xl",
					children: "Un spațiu de lucru dedicat GEO și AEO — cercetare, metodologie, experimente publice, studii de caz, articole și audit pentru cei care vor să fie găsiți, citați și recomandați de ChatGPT, Gemini, Perplexity, Claude și Copilot."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "mt-4 text-base text-[#e8e0cf]/70 leading-relaxed max-w-2xl",
					children: [
						...
						", care documentează aici cercetarea, măsurătorile și optimizările realizate în domeniul AI Visibility, GEO și AEO."
					]
				})
			]
		})]
	...
	/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "grid gap-px bg-foreground/10 border border-foreground/10 sm:grid-cols-2",
			children: labNav.map((item, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link$1, {
				to: item.to,
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "font-serif text-2xl leading-tight tracking-tight text-balance group-hover:text-foreground",
						children: item.label
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					item.children && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
						...
						children: item.children.map((child) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
...
var LabDetail = ({ pathname }) => {
	const page = findLabPage(pathname);
	if (!page) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Navigate$1, {
		to: "/lab",
		replace: true
	});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Seo, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "container-editorial py-20 md:py-28 max-w-4xl",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link$1, {
					to: parent ? parent.to : "/lab",
					className: "inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors mb-8",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeft, { className: "h-3.5 w-3.5" }), parent ? parent.label : "AI Visibility Lab"]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "eyebrow mb-6",
					children: ["AI Visibility Lab", parent ? ` · ${parent.label}` : ""]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					className: "font-serif text-3xl md:text-5xl leading-tight tracking-tight text-balance",
					children: page.pageTitle ?? page.label
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				(() => {
					const contentBlock = content ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-sm uppercase tracking-[0.22em] text-muted-foreground mb-3",
							children: "Pagină dedicată articolelor și studiilor de caz"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-base text-foreground/80 leading-relaxed",
							children: "Secțiunea reunește în prezent analize și studii de caz publicate de AI Visibility Lab și este actualizată pe măsură ce activitatea de cercetare evoluează.”"
						})]
					}, "content");
					const childrenBlock = articlesFirst ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LabArticleIndex, {}, "children") : caseStudiesFirst ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LabCaseStudyIndex, {}, "children") : page.children && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-16",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "eyebrow mb-6",
							children: "În această secțiune"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
							className: "grid gap-px bg-foreground/10 border border-foreground/10 sm:grid-cols-2",
							children: page.children.map((child) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
								className: "bg-background",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link$1, {
									to: child.to,
									className: "group flex flex-col p-6 hover:bg-surface/60 transition-colors h-full",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "font-serif text-lg leading-tight text-balance group-hover:text-foreground",
										children: child.label
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					return articlesFirst || caseStudiesFirst ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [childrenBlock, contentBlock] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [contentBlock, childrenBlock] });
				})()
			]
		})
	})] });
...
//#endregion
export { LabIndex as n, LabDetail as t };
