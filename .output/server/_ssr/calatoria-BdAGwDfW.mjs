import { j as Seo, t as Link$1 } from "./router-BGlFS8WK.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/calatoria-BdAGwDfW.js
...
var timeline = [
	...
	},
	{
		...
		description: "Dezvoltarea hubului personal Alex Matescu și începutul unei direcții noi în jurul GEO, AEO, inteligenței artificiale, scrisului și leadershipului."
	}
];
var chapters = [
	{
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Alexandru (Alex) Matescu este inginer, antreprenor, consultant AI Visibility și autor român, născut și crescut în Strâmba Jiu, județul Gorj." }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-muted-foreground",
						children: "Printre proiectele sale se numără CRANDIT – Mitul succesului peste noapte, afacerea de familie din mediul rural, Taste the Corn, Atracțiile României și GEO / AI Visibility."
					})
				]
			})]
		}),
