...
export const motoareCautareHtml = `
      ...
      <p><em>Articol publicat de AI Visibility Lab, proiectul de cercetare în vizibilitate AI al lui Alex Matescu, inginer de sisteme, antreprenor și consultant în vizibilitate AI, Sibiu. Ultima verificare factuală și actualizare: 18 august 2026.</em></p>
`;
